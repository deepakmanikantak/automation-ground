...
public class AssignmentTestB {
    ...
    public void addItemToCart() throws InterruptedException {
        ...
        // Hover SignIN , Checkout ,
        WebElement signIn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(AssignmentTest.signInXpath)));
        signIn.click();
